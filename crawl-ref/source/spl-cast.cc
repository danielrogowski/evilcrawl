                ...
                const string &title, spell_selector selector)
{
    ...
    if (Options.wide_spell_list)
    {
        ...
        MenuEntry* me = new MenuEntry(header, MEL_ITEM);
                           ...
                           bolt& beam, god_type god, bool fail)
{
    ...
    case SPELL_SHADOW_CREATURES:
        return cast_shadow_creatures(spell, god, level_id::current(), fail, powc);
...
{
    const int pow = calc_spell_power(spell, true, false);
